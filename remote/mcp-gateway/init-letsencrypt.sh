...
# Script to obtain Let's Encrypt certificates for mcp.timelinesaitech.com

domains=(mcp.timelinesaitech.com)
rsa_key_size=4096
data_path="./certbot"
email="admin@timelinesaitech.com" # Change this to your email
